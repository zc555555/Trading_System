...
def test_miner_bash_allowlist():
    ...
    assert _dec(_bash(f"{PY} research/mining/harness.py memory --part 3")) == "allow"
    assert _dec(_bash(f"{PY} research/mining/harness.py --horizon 5 memory --part 12")) == "allow"
    assert _dec(_bash(f"{PY} research/mining/harness.py memory --part x")) == "deny"
    assert _dec(_bash(f"{PY} research/mining/harness.py --horizon 5 memory")) == "allow"
