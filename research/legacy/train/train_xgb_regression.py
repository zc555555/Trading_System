"""
Train XGBoost Regression model to predict tomorrow's exact price change.
This is for accurate price forecasting, not just buy/sell signals.
"""
...
def train_regression_model():
    """Train regression model to predict exact price change."""

    print("=" * 80)
    print("TRAINING REGRESSION MODEL FOR PRICE PREDICTION")
    print("=" * 80)
    ...
    xgb_params.pop('scale_pos_weight', None)  # Not used in regression
    ...
    model_path = artifacts_dir / "xgboost_regression_model.pkl"
    ...
    print("\nThis model predicts tomorrow's exact price change.")
    print("Use it together with the classification model for best results.")
